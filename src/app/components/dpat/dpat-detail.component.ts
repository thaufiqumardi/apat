...
export class DpatDetailComponent{
    ...
    selectedDpatDetail = new DpatDetail();
    onPerincian(index:number){
        this.selectedDpatDetail=this.dpat.dpatDetail[index];       
        // console.log("dari dpatdetail", this.selectedDpatDetail);
    }
}
